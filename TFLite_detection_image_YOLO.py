...
for image_path in images:
    ...
    for i in range(len(classes)):
        ...
        if ((max_value > min_conf_threshold) and (max_value <= 1.0)):
            ...
            image = cv2.rectangle(image, (box_mins[0],box_mins[1]), (box_maxes[0],box_maxes[1]), col, 1)
            # Draw label
            ...
            cv2.rectangle(image, (box_mins[0], label_ymin-labelSize[1]-10), (box_mins[0]+labelSize[0], label_ymin+baseLine-10), col, cv2.FILLED) # Draw white box to put label text in
